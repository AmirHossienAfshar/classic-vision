...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.6]{assets/1.1.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{assets/1.2.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{assets/1.3.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.3]{assets/1.5.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{assets/code.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{assets/3.3.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{assets/3.5.png}
...
همچنین تابعی را پیاده کردم که به شکل دقیقی، دو تصویر متوالی را روی هم با استفاده از فیچر های مچ شده قرار میداد و همچنین آن نقاط مچ شده را نیز نمایش میداد:
 ...
 \begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{assets/5.1.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{assets/5.2.png}
...
%			\item medium: A Beginners Guide to Computer Vision (Part 4)- Pyramid \url{https://medium.com/analytics-vidhya/a-beginners
%				-guide-to-computer-vision-part-4-pyramid-3640edeffb00}
%
%		\end{enumerate}
%	\end{latin}
%\end{LTR}
